...
- ⏱️ **Dispatch Windows & Rolling Caps**: Configure inter-message delays and a dispatch window; all SMTP delivery attempts, including failed submissions, count toward the rolling 24-hour cap.
- 🗓️ **Scheduled Individual Emails**: Validate JSON payloads, inspect live rendered previews, run SMTP preflight, and edit or cancel standalone emails before their send time.
